/*
  # Randomly Assign Services to ALL Therapists
  
  This migration assigns random combinations of services to every therapist
  in the database, regardless of city.
*/
...
-- About 25% get Christian Counseling
UPDATE therapists 
